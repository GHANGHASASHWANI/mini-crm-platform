...
// //         <Sidebar />
// //         <main
// //           className="d-flex justify-content-center align-items-center flex-grow-1 px-4"
// //           style={{ backgroundColor: "#fff" }}
// //         >
// //           <section
// //             className="shadow rounded-4 d-flex flex-column align-items-center"
// //             style={{
// //               marginLeft : "250px",
// //               width: "400px",
// //               maxWidth: "90vw",
...
// //             >
// //               <i className="fas fa-user-circle me-3" style={{ fontSize: "2rem", color: "#4285F4" }}></i>
// //               Welcome !!
// //             </h2>
// //             <button
...
// //                 e.currentTarget.style.boxShadow = "0 4px 10px rgba(195, 60, 47, 0.6)";
// //               }}
// //               onMouseLeave={(e) => {
// //                 e.currentTarget.style.backgroundColor = "black";
// //                 e.currentTarget.style.boxShadow = "0 3px 6px rgba(219, 68, 55, 0.5)";
// //               }}
// //             >
...
// //               <a href="/terms" style={{ color: "#4285F4", fontWeight: "600" }}>
// //                 Terms of Service
// //               </a>{" "}
// //               and{" "}
// //               <a href="/privacy" style={{ color: "#4285F4", fontWeight: "600" }}>
// //                 Privacy Policy
// //               </a>
// //               .
// //             </p>
...
//     <>
//       <Navbar />
//       <div className="d-flex" style={{ height: "calc(100vh - 60px)", backgroundColor: "#fff" }}>
//         <Sidebar />
//         <main className="flex-grow-1 px-4" style={{ backgroundColor: "#fff", marginLeft: "250px" }}>
//           {/* Login card content... */}
//           <button
//             className="btn d-flex align-items-center justify-content-center w-100 mb-3"
//             onClick={handleGoogleLogin}
//             style={{ backgroundColor: "black", color: "#fff", fontSize: "1.15rem", borderRadius: "12px", gap: "10px", padding: "12px", fontWeight: "600", border: "none" }}
//           >
//             <i className="fab fa-google" style={{ fontSize: "1.5rem" }}></i>
//             Continue with Google
//           </button>
