...
//             <Card.Header className="bg-secondary text-white">Recent Activity Overview</Card.Header>
//             <Card.Body>
//               {topCampaigns.length > 0 ? (
//                 <TopCampaignsChart data={topCampaigns} />
//               ) : (
//                 <p className="text-muted text-center">(No campaign data available)</p>
//               )}
//             </Card.Body>
//           </Card>
//         </div>
...
//         <div className="col-md-6">
//           <Card className="shadow-sm">
//             <Card.Header className="bg-info text-white">Quick Insights</Card.Header>
//             <Card.Body>
//               {topCustomers.length > 0 ? (
//                 <TopEngagedCustomersLineChart data={topCustomers} />
//               ) : (
//                 <p className="text-muted text-center">(No customer engagement data)</p>
//               )}
//             </Card.Body>
//           </Card>
//         </div>
