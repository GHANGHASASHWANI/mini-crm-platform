...
//   if (loading) return <div className="text-center p-4"><div className="spinner-border text-primary" role="status"></div></div>;
//   if (error) return <div className="alert alert-danger">Error: {error}</div>;

//   return (
//     <div className="container py-4">
//       <h1 className="mb-4 fw-bold fs-3">Customer Segments</h1>
...
//                       {desc.includes("Spend") && <i className="fas fa-dollar-sign text-success me-2"></i>}
//                       {desc.includes("Visits") && <i className="fas fa-eye text-primary me-2"></i>}
//                       {desc.includes("created") && <i className="fas fa-user-plus text-purple me-2"></i>}
//                       {desc.includes("Last active") && <i className="fas fa-clock text-warning me-2"></i>}
//                       {desc.includes("after") && !desc.includes("active") && <i className="fas fa-calendar-plus text-secondary me-2"></i>}
//                       <span>{desc}</span>
//                     </li>
//                   ))}
//                 </ul>
